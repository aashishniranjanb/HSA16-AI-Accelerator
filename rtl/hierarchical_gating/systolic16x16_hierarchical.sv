//============================================================
// Systolic 16×16 with Hierarchical Gating — Weight-Stationary Array
//============================================================

`include "hsa_params.svh"

module systolic16x16_hierarchical
(
    input  logic                                 clk,
    input  logic                                 rst_n,
    ...
    //----------------------------------------------------------
    // 7. Statistics Gating Accumulation
    //----------------------------------------------------------
    always_comb begin
        total_tile_gated = '0;
        total_row_gated  = '0;

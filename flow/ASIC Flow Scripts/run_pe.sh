#!/bin/bash
#===============================================================================
# HSA16 Automation Script - run_pe.sh
# Target: PE Gating Architecture (Simulation -> VCD -> SAIF -> Genus -> Innovus)
#===============================================================================
...
ARCH="pe_gating"
TB_FILE="tb/pe_gating/tb_b16_pe_gated.sv"
RTL_FILES=(
    "rtl/common/hsa_params.svh"
    "rtl/pe_gating/pe_gated.sv"
    "rtl/pe_gating/systolic16x16_pe_gated.sv"
)

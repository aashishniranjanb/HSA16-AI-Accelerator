#!/bin/bash
#===============================================================================
# HSA16 Automation Script - run_row.sh
# Target: Row Gating Architecture (Simulation -> VCD -> SAIF -> Genus -> Innovus)
#===============================================================================
...
ARCH="row_gating"
TB_FILE="tb/row_gating/tb_b16_row_gated.sv"
RTL_FILES=(
    "rtl/common/hsa_params.svh"
    "rtl/row_gating/pe_row_gated.sv"
    "rtl/row_gating/systolic16x16_row_gated.sv"
)

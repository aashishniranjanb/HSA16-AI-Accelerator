#!/bin/bash
#===============================================================================
# HSA16 Automation Script - run_hierarchical.sh
# Target: Hierarchical Gating Architecture (Simulation -> VCD -> SAIF -> Genus -> Innovus)
#===============================================================================
...
ARCH="hierarchical"
TB_FILE="tb/hierarchical_gating/tb_b16_hierarchical.sv"
RTL_FILES=(
    "rtl/common/hsa_params.svh"
    "rtl/hierarchical_gating/pe_hierarchical.sv"
    "rtl/hierarchical_gating/systolic16x16_hierarchical.sv"
)

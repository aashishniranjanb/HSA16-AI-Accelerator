#!/bin/bash
#===============================================================================
# HSA16 Automation Script - run_tile.sh
# Target: Tile Gating Architecture (Simulation -> VCD -> SAIF -> Genus -> Innovus)
#===============================================================================
...
ARCH="tile_gating"
TB_FILE="tb/tile_gating/tb_b16_tile_gated.sv"
RTL_FILES=(
    "rtl/common/hsa_params.svh"
    "rtl/tile_gating/pe_tile_gated.sv"
    "rtl/tile_gating/systolic16x16_tile_gated.sv"
)

#===============================================================================
# Cadence Genus Synthesis Script - Tile Gating Architecture
...
set RTL_FILES [list \
    ...
    "${PROJECT_ROOT}/rtl/tile_gating/pe_tile_gated.sv" \
    "${PROJECT_ROOT}/rtl/tile_gating/systolic16x16_tile_gated.sv" \
]

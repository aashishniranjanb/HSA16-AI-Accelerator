#===============================================================================
# Cadence Genus Synthesis Script - Hierarchical Gating Architecture
...
#-------------------------------------------------------------------------------
set ARCH_NAME         "hierarchical"
set DESIGN            "systolic16x16_hierarchical"
...
set RTL_FILES [list \
    ...
    "${PROJECT_ROOT}/rtl/hierarchical_gating/pe_hierarchical.sv" \
    "${PROJECT_ROOT}/rtl/hierarchical_gating/systolic16x16_hierarchical.sv" \
]
